  ...
  return (
    ...
    >
      <div className="relative grid h-137.5 flex-1 grid-cols-2 gap-2 border-y border-neutral-500/20">
        <span className="absolute top-0 left-0 h-2 w-2 border-t border-l border-rose-600 transition-colors group-hover:border-white" />
        <span className="absolute top-0 right-0 h-2 w-2 border-t border-r border-rose-600 transition-colors group-hover:border-white" />
        <span className="absolute bottom-0 left-0 h-2 w-2 border-b border-l border-rose-600 transition-colors group-hover:border-white" />
        <span className="absolute right-0 bottom-0 h-2 w-2 border-r border-b border-rose-600 transition-colors group-hover:border-white" />

        <div className="group relative h-full w-full overflow-hidden p-1">
          <DitherShader
